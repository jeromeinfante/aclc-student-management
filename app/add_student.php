...
// $add = "INSERT INTO `testing` (`name`, `gmail`, `cp`, `hometown`) VALUES ('$fullname', '$gmail', '$cp_number', '$hometown')";
...
if (empty($fullname)) {
    ...
    mysqli_query($conn, "INSERT INTO `student_info` (stud_name, stud_gmail, stud_cp_number, stud_hometown, stud_grade, stud_section, stud_strand) VALUES ('$fullname', '$gmail', '$cp_number', '$hometown', '$grade', '$section', '$strand')");
